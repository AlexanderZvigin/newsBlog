...
<div class="bform py-5">
 ...
 <div class="">
 <h2 class="mb-3 font-weight-light">Регистрация аккаунта</h2>
 <h6 class="subtitle font-weight-normal">Это займет не более 2 минут!</h6>
  <?php
  for ($i=0; $i <12; $i++) {
if (!empty($_SESSION[error_message[$i]])) {
  echo '<div class="alert alert-danger" role="alert">';
echo $_SESSION[error_message[$i]];
echo  '</div>' ;
}
}
 ?>

 <form class="mt-3" action="save_user.php" method="post">
 <div class="row">
 <div class="col-lg-12">
 ...
 У вас уже есть аккаунт? <a href="auth_form.php" class="text-danger">Войти</a>
 </div>
 </div>
 </div>
 </div>
